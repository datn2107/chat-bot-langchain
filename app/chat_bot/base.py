...
from app.internal import message_history_repository
...
class ChatBotBase:
    ...
    def load_memory(self, user_email: str):
        ...
        messages = message_history_repository.get_last_10_messages(user_email)
    ...
    async def ask(self, user_email: str, message: str) -> str:
        message_history_repository.add_message(
